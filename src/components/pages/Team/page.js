...
const founders = [
  {
    name: 'Dinis Guarda',
    text:
      'Dinis Guarda is an author, founder and experienced CEO, specialised in Strategy, Digital transformation, and a Blockchain, Crypto economics/ ICO Evangelist. He is interested as well in cutting-edge breakthroughs in life science, and green energy solutions using the best of AI, big data, and distributed ledgers. In 2011 he created Ztudium, that manages and publishes intelligenthq.com, openbusinesscouncil.org, tradersdna.com, and hedgethink.com. He is a guest lecturer at Copenhagen Business School, Cambridge University, Group INSEEC - Monaco University, where he leads the digital master course in London, and teaches digital healthcare. He is an active speaker and author in conferences and other educational events and workshops. Between 2014 and 2015 he was involved in creating a digital bank and investment platform between Asia and Africa funded by among others, Rothschild family. He was involved in its business development, technological setup and legal international foundations working as founder COO and CMO.',
  ...
  },
  {
    name: 'Ajan Reginald',
    text:
      'Ajan Reginald is a recognised entrepreneur, expert and thought the leader in the fields of Science and Medicine. Since 2006 Ajan has been the Founder and CEO of Celixir, a leading scientific company that develops cellular medicines and solutions to combat life-threatening and life-altering diseases. This company was co-founded with Professor Sir Martin Evans, Nobel of Medicine. Celixir is an award-winning biotech company developing stem cell therapeutics with products already reaching phase II and phase III of clinical trials. Ajan has worked as Global Head of Emerging Technologies and Ex-Business Development Director at Roche.Previously, he was a Consultant for the Boston Consulting Group. He studied at the Kellogg School of Management, was a Fulbright Scholar and did his initial academic studies at the University of London. Ajan holds a Master of Science Field Of Study, Experimental Therapeutics at the University of Oxford Ajan Reginald is on a mission to reinvent health care, AI, cell therapy and in many ways the way the future of what human body will be and our singularity.',
