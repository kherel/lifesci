    ...
    return (
      <div className={cn()}>
        <A_Container type='section'>
          <A_H type='about' mx={cn('title')}>LifeSci company gives access to new breakthrough life science companies and innovative startups, and a unique platform using blockchain technology. The platform is dedicated to the life sciences ecosystem including companies portfolio, industry research and data analysis. </A_H>
