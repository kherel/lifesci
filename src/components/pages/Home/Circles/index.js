...
const cn = cssClassName('HomeCircles')

const HomeCircles = () =>(
  <div className={cn()}>
    <svg width="100%" viewBox="-625 -180 1250 360" xmlns="http://www.w3.org/2000/svg"
    >
      <defs >
      ...
      <circle r="4" id="circle-1" opacity="0">
        ...
        <animate attributeName="fill" values="white;white;black;black;white;white" dur="6s" begin="4.5s" repeatCount="indefinite" />
      ...
      <circle r="4" fill="#000" id="circle-2" opacity="0">
        ...
        <animate attributeName="fill" values="white;white;black;black;white;white" dur="2s" begin="1.5s" repeatCount="indefinite" />
      ...
      <circle r="5" fill="#000" id="circle-3" opacity="0">
        ...
        <animate attributeName="fill" values="white;white;black;black;white;white" dur="3s" begin="2.25s" repeatCount="indefinite" />
      ...
      <circle r="5" fill="#000" id="circle-3" opacity="0">
        ...
        <animate attributeName="fill" values="white;white;black;black;white;white" dur="5.5s" begin="4.125s" repeatCount="indefinite" />
      ...
      <circle r="5" fill="#000" id="circle-4" opacity="0">
        ...
        <animate attributeName="fill" values="white;white;black;black;white;white" dur="5s" begin="3.75s" repeatCount="indefinite" />
      ...
      <circle r="5" fill="#000" id="circle-4" opacity="0">
        ...
        <animate attributeName="fill" values="white;white;black;black;white;white" dur="10s" begin="7.5s" repeatCount="indefinite" />
...
HomeCircles.propTypes = {
};

HomeCircles.defaultProps = {
}
