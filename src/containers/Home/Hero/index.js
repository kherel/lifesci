        ...
        <A_Container type='normal'>
          ...
          <div className={cn('inner')}>
            <div className={cn('info')}>
              ...
              <A_P type="hero">Lifesci is a unique vehicle to offer access to valuable licence fee income and a blockchain AI driven platform / exchange / big data intelligence platform that gives investor access to the latest insights, news in the healthcare industry.</A_P>
            ...
            <div className={cn('timer')}>
              ...
              <div className={cn('timer-inner')}>
                <A_H type='timer'>Crowdsale begins October 14th at 2pm GMT</A_H>
                <O_FlipClock />
